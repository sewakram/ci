                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                             ...
                             <div class="col-sm-8">
                               <?php echo form_open_multipart('administrator/add_magazines'); ?>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                             <!-- <input type="text" name="publisher_company" class="form-control" placeholder="Publishing Company"> -->
                                             ...
                                             <select class="js-example-basic-single col-sm-10" name="publisher_company">
                                                <?php foreach ($datapublisher as $publisher_company) { ?>
                                                    <option value="<?=$publisher_company['id']?>"><?=$publisher_company['name'].' ('.$publisher_company['publisher'].')'?></option>
                                                <?php  } ?>
                                    ...
                                    <!-- <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input name="imgFiles" class="form-control" type="file">
                                        </div>
                                    </div>
