                ...
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body">
                            ...
                            <div class="text-center">
                                <img src="<?php echo base_url(); ?>assets/images/<?php echo $logo[0]['logo_img'];?>" alt="Your Logo Here">
                            </div>
                            ...
                            <div class="auth-box">
                                ...
                                <div class="row m-t-30">
                                    ...
                                    <div class="col-md-12">
                                        <a href="<?php echo base_url(); ?>publisher/register" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20"> Register as publisher</a>
                                    </div>
                                </div>
                                <hr/>
                                <div class="row">
