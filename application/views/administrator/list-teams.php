            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>administrator/team/list">Advertisements</a>
                        </li>
                            ...
                            <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                ...
                                <?php foreach($teams as $team) : ?>
                                 <tr>
                                        ...
                                        <td><?php echo $team['section']; ?></td>
                                        <td>
                                            <img width="300px;" src="<?php echo site_url();?>assets/images/teams/<?php echo $team['image']; ?> ">                                           
                                        </td>
