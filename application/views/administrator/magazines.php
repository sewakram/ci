                                 ...
                                 <tr>
                                        ...
                                        <td>
                                               ...
                                               <a class="label label-inverse-primary enable" href='<?php echo base_url(); ?>administrator/enable/<?php echo $post['id']; ?>?table=<?php echo base64_encode('add_magazines'); ?>'>Enabled</a>
                                                ...
                                                <a class="label label-inverse-info" href='<?php echo base_url(); ?>administrator/new-issue/<?php echo $post['id']; ?>'>Add Issue</a>

                                                <a class="label label-inverse-info" href='<?php echo base_url(); ?>administrator/issues/<?php echo $post['id']; ?>'>View Issues</a>
