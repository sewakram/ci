                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                             ...
                             <div class="col-sm-8">
                               <?php echo form_open_multipart('administrator/update_magazines/'.$magazines['id']); ?>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <!-- <input type="text" name="publisher_company" class="form-control" placeholder="Publishing Company" value="<?php //echo $magazines['publisher_company'];?>"> -->
                                            <?php $datapublisher = $this->Administrator_Model->get_publisher();
                                              ?>
                                             <select class="js-example-basic-single col-sm-10" name="publisher_company">
                                                <?php foreach ($datapublisher as $publisher_company) { ?>
                                                    <?php $pubselect = ''; if( $magazines['user_id'] == $publisher_company['id'] ): $pubselect = 'selected="selected"'; endif;?>
                                                    <option <?=$pubselect?> value="<?=$publisher_company['id']?>"><?=$publisher_company['name'].' ('.$publisher_company['publisher'].')'?></option>
                                                <?php  } ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="js-example-basic-single col-sm-10" name="primary_category">
