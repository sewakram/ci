                            ...
                            <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                ...
                                foreach($transactions as $key=>$post) { ?>
                                 <tr>
                                        ...
                                        <td>
                                        <?php 
                                        $earning=$post['amount']-($post['amount']*10/100);
                                        ...
                                        <td>
                                                ...
                                                <a class="label label-inverse-info" href='<?php echo base_url(); ?>publisher/transaction/<?php echo base64_encode($post['id']); ?>'>View Details</a>
