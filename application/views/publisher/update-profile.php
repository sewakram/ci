                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                             <div class="col-sm-8">
                               <?php echo form_open_multipart('publisher/update_publisher_profile_data'); ?>
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="publisher" name="publisher" title="Publishing Company Name" class="form-control form-txt-primary" value="<?php echo $publisher_details['publisher']; ?>" placeholder="Publishing Company Name">
                                        </div>
                                    </div>
                                     <div class="form-group row">
