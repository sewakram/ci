...
<div id="headbg">
<div class="container">
<div class="logo"><a href="<?=site_url();?>"><img src="<?php echo base_url(); ?>assets/images/front/idondza.jpg" alt="idondza" /></a></div>
<div class="search">
	<form method="get" action="<?php echo (isset($is_home))? site_url('/search') : '';?>">
  	<input class="searchbox" type="text" name="search" placeholder="Search" aria-label="Search">
	<input class="srhico" type="submit" value="" >
  </form>
